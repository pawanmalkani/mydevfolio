    ...
    return (
        <div className="icons mt-1 flex space-x-4">
            <button
                ...
                className="m-2 inline-block rounded-2xl bg-transparent p-3 text-6xl font-medium uppercase leading-normal text-black  transition duration-150 ease-in-out hover:bg-[radial-gradient(circle,_rgba(0,225,255,1)_0%,_rgba(175,222,222,1)_100%)] hover:text-black focus:outline-none focus:ring-0 active:shadow-lg cursor-pointer">

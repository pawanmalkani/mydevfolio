...
function App() {
  ...
  useEffect(() => {
      ...
      (entries) => {
        entries.forEach((entry) => {
          ...
          if (entry.isIntersecting) {
            if (el.classList.contains('animate-on-scroll-bottom')) {
              el.classList.add('slide-in-bottom');
            }
          } else {
            // Match the animation duration (1.5s)
            setTimeout(() => {
    ...
    const elements = document.querySelectorAll('.animate-on-scroll-bottom');
  ...
  return (
    <>
      ...
      <div className="maincontainer w-full h-full bg-white overflow-y-hidden overflow-hidden">
        ...
        {/* <div className="flex flex-col lg:flex-row w-full h-full rounded-xl justify-center shadow-lg min-h-screen">
          <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-10 bg-[radial-gradient(circle,_rgba(0,225,255,1)_0%,_rgba(175,222,222,1)_100%)]">
          ...
          <div className="w-full lg:w-1/2 text-xl text-black font-mono space-y-4 px-6 pt-10 bg-white 
          lg:bg-[radial-gradient(circle,_rgba(0,225,255,1)_0%,_rgba(175,222,222,1)_100%)] flex items-center justify-center
          md:flex-col">
            <div className="w-full max-w-xl py-10 lg:mt-5 lg:ml-30">

              <h1 className="text-4xl mb-10 text-center lg:text-center lg:mr-70 whitespace-nowrap robotoslap">About Me!</h1>
        ...
        >
          ...
          >
            ...
            <div className="fullname mt-4 text-2xl font-semibold text-center">
              <span className='text-gray-200'>-Pawan Malkani-</span>
              <span className="block text-lg text-white">Web Developer</span>
            </div>
            <div className="icons mt-1 flex space-x-4">
              {/* your social buttons as-is */}
              ...
              <button
                ...
                data-twe-ripple-color="light"
                onClick={() => window.open('https://www.instagram.com/pawannmalkani', '_blank')}
                className="m-2 inline-block rounded-2xl bg-transparent p-3 text-6xl font-medium uppercase leading-normal text-gray-400  transition duration-150 ease-in-out hover:text-white focus:outline-none focus:ring-0 active:shadow-lg cursor-pointer">
                <span className="[&>svg]:h-4 [&>svg]:w-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
          ...
          <div
            className="
              w-full lg:w-1/2 text-xl text-black font-mono space-y-4 px-6 pt-10
              bg-white lg:bg-transparent flex items-center justify-center
              md:flex-col
            "
          >
            <div className="w-full max-w-xl py-10 lg:mt-5 lg:ml-30">
              <h1 className="text-4xl mb-10 text-center lg:text-center lg:mr-70 whitespace-nowrap robotoslap lg:text-gray-100">
                About Me!
              </h1>
              <div className="flex flex-col sm:flex-row items-start sm:items-center pb-4 summary">
                <p className="font-semibold w-32 min-w-fit text-left lg:text-gray-300">Full Name:</p>
                <span className="text-gray-500 sm:ml-4 lg:text-gray-100">Pawan Mukesh Malkani</span>
              </div>
              <div className="flex flex-col sm:flex-row items-start sm:items-center pb-4 summary">
                <p className="font-semibold w-32 min-w-fit text-left lg:text-gray-300">Phone:</p>
                <span className="text-gray-500 sm:ml-4 whitespace-nowrap lg:text-gray-100">+91 7972101526</span>
              </div>
              <div className="flex flex-col sm:flex-row items-start sm:items-center pb-4 summary">
                <p className="font-semibold w-32 min-w-fit text-left lg:text-gray-300">Email:</p>
                <span className="text-gray-500 sm:ml-4 break-all lg:text-gray-100">malkanipawan1@gmail.com</span>
              </div>
              <div className="flex flex-col sm:flex-row items-start sm:items-center pb-4 summary">
                <p className="font-semibold w-32 min-w-fit text-left lg:text-gray-300">Address:</p>
                <span className="text-gray-500 sm:ml-4 lg:text-gray-100">Mumbai, India</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="myresume text-base sm:text-xl text-black font-mono rounded-xl shadow-lg px-4 sm:px-8 lg:px-16">
          <h1 className="text-3xl sm:text-4xl mt-12 text-center mb-7 robotoslap">My Resume</h1>
            ...
            <div className="relative z-10 mt-10 p-6 sm:p-8 shadow-md rounded-xl border border-gray-200 w-full max-w-4xl mx-auto animate-on-scroll-bottom bg-no-repeat bg-[center_20%] lg:bg-center bg-cover"
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6 ">
                ...
                <div className="flex flex-col lg:ml-48 summary" >
                  <p className="text-xl lg:text-3xl sm:text-2xl font-semibold text-gray-300 leading-snug">
                    Tata Advanced Systems Limited
                  </p>
                  <p className="text-sm sm:text-base text-gray-500 mt-1 lg:text-2xl">
                    July 2021 – Present
                  </p>
                  <p className="text-sm sm:text-base text-gray-300 mt-3 leading-relaxed font-bold lg:text-xl">
            ...
            <div className="animate-on-scroll-bottom relative z-10 mt-10 p-6 sm:p-8 shadow-md rounded-xl border border-gray-200 w-full max-w-4xl mx-auto bg-no-repeat bg-[center_20%] lg:bg-center bg-cover"
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6">
                ...
                <div className="flex flex-col lg:ml-40 summary" >
                  <p className="text-xl sm:text-2xl font-semibold text-gray-300 leading-snug lg:text-3xl">
                    Bachelors Degree
                  </p>
                  <p className="text-sm sm:text-base text-gray-500 mt-1 lg:text-2xl">
            ...
            <div className="animate-on-scroll-bottom relative z-10 mt-10 p-6 sm:p-8 shadow-md rounded-xl border border-gray-200 w-full max-w-4xl mx-auto bg-no-repeat bg-[center_20%] lg:bg-center bg-cover"
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6">
                ...
                <div className="flex flex-col lg:ml-50 summary ">
                  <p className="text-xl sm:text-2xl font-bold text-gray-300 leading-snug lg:text-3xl">
                    School
                  </p>
        ...
        <div className="myresume text-base sm:text-xl text-black font-mono rounded-xl shadow-lg px-4 sm:px-8 lg:px-16">
          <h1 className="text-3xl sm:text-4xl mt-12 text-center mb-7 robotoslap">Skills</h1>
          <div className="min-h-screen bg-white p-4">
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 place-items-center text-6xl summary text">
        ...
        <div className="myresume text-base sm:text-xl text-black font-mono rounded-xl shadow-lg px-4 sm:px-8 lg:px-16">
          <h1 className="text-3xl sm:text-4xl mt-12 text-center robotoslap mb-7">My Endeavours</h1>
